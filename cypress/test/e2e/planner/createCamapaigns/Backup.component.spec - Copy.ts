...
describe(featureName, () => {
  ...
  // Create campaign
  it.skip('E2E Positive Scenario - Data Set 1', () => {
  ...
  it.skip('E2E Positive Scenario - Data Set 2', () => {
    cy.get('.cad-global-create-modern__button > .cad-button').click();
    cy.get('.cad-row_clear > .title').contains('New Campaign');
  ...
  it.skip('E2E Create Campaign from Map', () => {
  ...
  //Edit campaign 
  it.skip('Add Media Owners Inventory to Campaign (Frames Only)', () => {
      ...
      .then(($span) => {
        ...
        for (var i = 1; i <= parseInt(count); i++) {
          cy.get(`:nth-child(` + i + `) > .sideSlidePanel__types__table__body__row-left > div`)
            .then(($span) => {
              var moName = $span.text().trim();
              cy.log(moName.toString());
              cy.log(mo[0].toString());
              console.log(moName.toString());
              console.log(mo[0].toString());
              if (moName.toString() == mo[0].toString()) {
                cy.get(`:nth-child(` + (i - 13) + `) > .sideSlidePanel__types__table__body__row-last 
                > :nth-child(2) > .bg-icon > .icon > use`).click();
              }
            });
        }
  ...
  it.skip('Add Media Owners Inventory to Campaign (POIs Only)', () => {
    cy.get('cad-icon.icon-search > .icon').click();
  ...
  it('campaignnames', () => {
    for (var i = 0; i <= PageAction.campaignList.length; i++) {
      cy.log(PageAction.campaignList[i]);
      console.log(PageAction.campaignList[i]);
    }
  })
  //Delete campaign
  ...
  //validate raportal logo
  it.skip('E2E validate raportal logo', () => {

    cy.get('#subheader-app-logo-ooh').should('be.visible');

    cy.get('#subheader-app-logo-ooh').its('background-image')
      .should('be', 'https://qa-rapportww.cadreonint.com/white-label/c8173bcca5be6f206ae926fb01a794ed.png');

    cy.get(':nth-child(2) > tr > .table__col-160 > .title').click();
    cy.get('campaign-detail-basic.ng-star-inserted > :nth-child(1) > .col-md-12 > .title')
